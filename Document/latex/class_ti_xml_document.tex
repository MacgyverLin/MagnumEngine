...
類別\+Ti\+Xml\+Document的繼承圖\+:\begin{figure}[H]
\begin{center}
\leavevmode
...
The error state is automatically cleared if you Parse a new X\+ML block. \index{Ti\+Xml\+Document@{Ti\+Xml\+Document}!Clone@{Clone}}
...
Returns true if successful. Will delete any existing document data before loading. \index{Ti\+Xml\+Document@{Ti\+Xml\+Document}!Load\+File@{Load\+File}}
\index{Load\+File@{Load\+File}!Ti\+Xml\+Document@{Ti\+Xml\+Document}}
