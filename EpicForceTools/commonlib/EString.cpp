...
{
	return strcmp(buffer.c_str(), other.buffer.c_str())==0;
}

bool String::operator==(const char *str) const
{
	return strcmp(buffer.c_str(), str)==0;
}
...
int String::trim(int direction)
{
	...
	buffer = extract(start, end-start+1);

	return 0;
}

String String::extract(int start, int length) const
{
	String str(this->text(start), length);
...
{
	return String(buffer.substr(start, count).c_str());
}

int String::find_first_of(const char *delimiters) const
{
	return buffer.find_first_of(delimiters);
}

int String::find_first_not_of(const char *delimiters) const
{
	return buffer.find_first_not_of(delimiters);
}

int String::find_last_of(const char *delimiters) const
{
	return buffer.find_last_of(delimiters);
}

int String::find_last_not_of(const char *delimiters) const
{
	return buffer.find_last_not_of(delimiters);
}

int String::find_first_of(const char *delimiters, int pos) const
{
	return buffer.find_first_of(delimiters, pos);
}

int String::find_first_not_of(const char *delimiters, int pos) const
{
	string::size_type t1 = buffer.find_first_not_of(delimiters, pos);
	return buffer.find_first_not_of(delimiters, pos);
}

int String::find_last_of(const char *delimiters, int pos) const
{
	return buffer.find_last_of(delimiters, pos);
}

int String::find_last_not_of(const char *delimiters, int pos) const
{
	return buffer.find_last_not_of(delimiters, pos);
}

const char *String::text(int at) const
{
	return &buffer[at];
}
...
{
	buffer.assign(buffer_, length_);

	return buffer.c_str();
}

char String::operator[](int at) const
{
	return buffer[at];
}
...
unsigned long EpicForce::HashKey(const char *str) 
{
