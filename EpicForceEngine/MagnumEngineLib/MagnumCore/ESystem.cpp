...
char *System::strcpy(char *dest, const char *src)
{
	return ::strcpy(dest, src);
}

char *System::strncpy(char *dest, const char *src, int count)
{
...
int System::strncmp(const char *str1, const char *str2, int maxcount)
{
	return ::strncmp(str1, str2, maxcount);
}

int System::strnicmp(const char *str1, const char *str2, int maxcount)
{
...
String System::getDirectory(const char *fullPath)
{
...
String System::getFileName(const char *fullPath)
{
...
String System::getExtension(const char *fullPath)
{
	const char *ext      = strrchr(fullPath, '.');
