...
int BezierCurve2::GetDegree () const
{
    return m_iDegree;
}
//----------------------------------------------------------------------------

const Vector2* BezierCurve2::GetControlPoints () const
{
    return m_akCtrlPoint;
}
//----------------------------------------------------------------------------

Vector2 BezierCurve2::GetPosition (float fTime) const
{
...
Vector2 BezierCurve2::GetFirstDerivative (float fTime) const
{
    float fOmTime = (float)1.0 - fTime;
    float fPowTime = fTime;
...
Vector2 BezierCurve2::GetSecondDerivative (float fTime) const
{
    float fOmTime = (float)1.0 - fTime;
    float fPowTime = fTime;
...
Vector2 BezierCurve2::GetThirdDerivative (float fTime) const
{
    if (m_iDegree < 3)
    {
        return Vector2::ZERO;
...
float BezierCurve2::GetVariation (float fT0, float fT1,
    const Vector2* pkP0, const Vector2* pkP1) const
{
    ...
    static const float s_fOneThird = (float)(1.0/3.0);
    float fDT = fT1 - fT0;
