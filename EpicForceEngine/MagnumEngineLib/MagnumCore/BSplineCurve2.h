...
//																				 //
///////////////////////////////////////////////////////////////////////////////////
#ifndef _BSplineCurve2_h_
#define _BSplineCurve2_h_
...
class BSplineCurve2 : public SingleCurve2
{
public:
    ...
    BSplineCurve2 (int iNumCtrlPoints, const Vector2* akCtrlPoint,
    ...
    void SetControlPoint (int i, const Vector2& rkCtrl);
    Vector2 GetControlPoint (int i) const;
    ...
    void Get (float fTime, Vector2* pkPos, Vector2* pkDer1,
        Vector2* pkDer2, Vector2* pkDer3) const;
...
protected:
    ...
    // be a closed curve.
    void CreateControl (const Vector2* akCtrlPoint);

    int m_iNumCtrlPoints;
    Vector2* m_akCtrlPoint;  // ctrl[n+1]
    bool m_bLoop;
