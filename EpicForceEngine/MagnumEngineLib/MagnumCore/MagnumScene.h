...
//																				 //
///////////////////////////////////////////////////////////////////////////////////
#ifndef _MagnumScene_h_
#define _MagnumScene_h_
...
public:
	...
	class Data
	{
	friend class MagnumScene;
	friend class MagnumScene::Resource;
	friend class MagnumScene::ResourceImporter;
	public:
		Data();
		~Data();
	...
	public:
		...
		DECLARE_RESOURCE(MagnumScene::Resource, MagnumScene)
	protected:
	...
	public:
		...
		DECLARE_RESOURCE_IMPORT(MagnumScene::ResourceImporter, MagnumScene, MagnumScene)
