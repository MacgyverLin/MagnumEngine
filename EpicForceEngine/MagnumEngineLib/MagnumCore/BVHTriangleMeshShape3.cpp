...
void BVHTriangleMeshShape3::getMassProp(float density, float &mass, Vector3 &localInertia) const
{
	//mass = volume * density;

	//btVector3 inertia;
	//((btMultimaterialTriangleMeshShape *)handle)->calculateLocalInertia(mass, inertia);
