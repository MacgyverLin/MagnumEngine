		...
		out float4 outputColor		: COLOR)
{
	...
	float4 glosssiness		= tex2D(glossMapSampler, inputTexCoord0);

	outputColor				= float4(inputColor0.rgb * diffuseColor.rgb + inputColor1.rgb * glosssiness.rgb, diffuseColor.a);
}
